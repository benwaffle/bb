    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Publish the agent's live slash-command list as extension state, so a running thread's `/` menu offers the agent's own commands beside the scanned catalog",
        ],
        apiSymbols: [
          ...
          "ContextCategory",
          "ContextEntry",
          "experimental_sessionCommandsStateSchema",
